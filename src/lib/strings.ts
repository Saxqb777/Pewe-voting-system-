...
export const strings = {
  ...
  status: {
    ...
    resultTitleHi: "Chunav ka nateeja",
    resultKicker: "Final result",
    resultHeading: (n: number) => `The ${n} elected`,
    resultHeadingHi: "Chune gaye log",
    resultVoted: "voted",
    resultTurnout: "turnout",
    resultVotes: "votes counted",
    resultMargin: "votes decided the last seat",
    resultStanding: "Everybody, in order",
    resultStandingHi: "Sabhi ummeedwaron ke vote",
    resultChecks: "The count, checked",
    resultChecksHi: "Ginti ki jaanch",
    resultCheckBallots: "Ballots in the box",
    resultCheckRoster: "Voters on the register",
    resultCheckVoted: "Voters marked as having voted",
    resultCheckVotes: "Individual votes counted",
    resultCheckSeats: "Seats to fill",
    resultCheckSum: "Seats times ballots, which the votes must equal",
    resultPrivacy:
